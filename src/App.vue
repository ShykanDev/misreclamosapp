<template>
  <ion-app>
     <!--Ion Menu-->
  <ion-menu type="push"  v-show="showMenu" menu="first-menu" content-id="main-content">
    <!--Ion Menu Header-->
...
const showMenu = computed(() => {
  // Ajusta las rutas donde quieres que aparezca el menú
  return route.path.startsWith('/home') || route.path.startsWith('/profile');
});
</script>
