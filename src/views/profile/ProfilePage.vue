         ...
         <ion-list v-if="userComplaints.length > 0">
              ...
              <ion-item-sliding v-for="complaint in userComplaints" :key="complaint.id || complaint.title" class="mb-2">
                ...
                <ion-item>
                  ...
                  <ion-label>
                    <h3 class="text-base font-semibold text-rose-800">{{ complaint.title }}</h3>
                  </ion-label>
                </ion-item>
...
import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonItem, IonIcon, IonButtons, IonBackButton, IonList, IonItemSliding, IonText, IonButton, onIonViewDidEnter, onIonViewDidLeave, IonSpinner, IonItemOptions, IonItemOption } from '@ionic/vue';
